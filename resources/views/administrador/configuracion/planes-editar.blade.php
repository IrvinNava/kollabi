      ...
      <div class="content">
         ...
         <nav class="mb-3" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
               ...
               <li class="breadcrumb-item fw-semibold"><a href="{{url('admin/configuracion/planes')}}">Planes de renta</a></li>
               <li class="breadcrumb-item fw-normal active">Plan compartido</li>
            </ol>
         </nav>
         ...
         <div class="mb-9">
            ...
            <div class="row g-3 flex-between-end mb-5">
               <div class="col-auto">
                  <h2 class="mb-2">Plan compartido</h2>
               </div>
                           ...
                           <div class="row g-3">
                              <div class="col-lg-6">
                                 ...
                                 <div class="form-icon-container">
                                    <input class="form-control ps-6" id="namePlan" name="namePlan" type="text" value="Plan compartido">
                              ...
                              <div class="col-lg-3">
                                 ...
                                 <div class="form-icon-container">
                                    <input class="form-control ps-6" id="costInput" name="costInput" type="text" value="1200">
                              ...
                              <div class="col-12">
                                 ...
                                 <select class="form-select multiple-select" id="sucursalSelect" multiple="multiple" >
                                    <option selected>Perpetua Zócalo</option>
                                    <option selected>Perpetua Apizaco</option>
                                 </select>
                              </div>
                           </div>
                           <hr class="mt-5 mb-4">
                           <div>
                              <div class="d-flex justify-content-between align-items-center w-100">
                                 ...
                                 <div class="form-check form-switch">
                                    ...
                                    <input class="form-check-input" id="comisionSwitch" type="checkbox" checked/>
                                 </div>
                              </div>
                              <div class="mb-3" id="percentageContainer">
                                 <label class="form-label" for="percentageComision">Escribe el porcentaje que se aplicará a cada venta</label>
                                 <div class="form-icon-container">
                                    <input class="form-control ps-6" id="percentageComision" name="percentageComision" type="text" value="10">
                           ...
                           <div class="bg-light rounded-3 p-3">
                              <div id="planFeaturesList" class="mb-">
                                 ...
                                 <div class="row g-2 mb-2 feature-item">
                                    <div class="col-md-11"><input class="form-control form-control-sm feature-input" type="text" value="Consulta de venta en tiempo real"></div>
                                    <div class="col-md-1">
                                 ...
                                 <!-- Item -->
                                 <div class="row g-2 mb-2 feature-item">
                                    <div class="col-md-11"><input class="form-control form-control-sm feature-input" type="text" value="Reporte de ventas diario."></div>
                                    <div class="col-md-1">
                                       <a href="javascript:void(0);" class="btn btn-sm btn-phoenix-secondary text-body-quaternary remove-feature"><i class="fas fa-trash"></i></a>
                                    </div>
                                 </div>
                                 <!-- Item -->
                                 <div class="row g-2 mb-2 feature-item">
                                    <div class="col-md-11"><input class="form-control form-control-sm feature-input" type="text" value="Estadisticas de ventas mensual"></div>
                                    <div class="col-md-1">
                                       <a href="javascript:void(0);" class="btn btn-sm btn-phoenix-secondary text-body-quaternary remove-feature"><i class="fas fa-trash"></i></a>
                                    </div>
                                 </div>
                                 <!-- Item -->
                                 <div class="row g-2 mb-2 feature-item">
                                    <div class="col-md-11"><input class="form-control form-control-sm feature-input" type="text" value="Una mención en redes semanal"></div>
                                    <div class="col-md-1">
                                       <a href="javascript:void(0);" class="btn btn-sm btn-phoenix-secondary text-body-quaternary remove-feature"><i class="fas fa-trash"></i></a>
                                    </div>
                                 </div>
                                 <!-- Item -->
                                 <div class="row g-2 mb-2 feature-item">
                                    <div class="col-md-11"><input class="form-control form-control-sm feature-input" type="text" value="Ubicación: Vitrina"></div>
                                    <div class="col-md-1">
                                       <a href="javascript:void(0);" class="btn btn-sm btn-phoenix-secondary text-body-quaternary remove-feature"><i class="fas fa-trash"></i></a>
                                    </div>
                                 </div>
