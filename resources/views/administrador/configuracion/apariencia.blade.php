                  ...
                  <div class="py-4 px-5 py-lg-5" style="height: 90vh;">
                     <div class="sticky-top" style="top: 96px;">
                        ...
                        <div>
                           ...
                           <a href="{{url('app/admin/configuracion/apariencia')}}" class="d-flex align-items-center link-submenu py-2 active">
                           ...
                           <a href="{{url('app/admin/configuracion/sucursales')}}" class="d-flex align-items-center link-submenu py-2">
               ...
               <div class="px-4 px-lg-5 py-5">
                  ...
                  <nav class="mb-3" aria-label="breadcrumb">
                     <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item fw-semibold"><a href="{{url('app/admin/configuracion/perfil-del-negocio')}}" class="text-primary">Perfil del negocio</a></li>
