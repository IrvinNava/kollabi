               ...
               <div class="px-4 px-lg-5 py-5">
                  ...
                  <nav class="mb-3" aria-label="breadcrumb">
                     <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item fw-normal active">Nueva sucursal</li>
                     </ol>
                  </nav>

                  <div class="d-flex flex-row flex-between-center">
                     <h2 class="mb-0">Nueva sucursal</h2>
                  ...
                  <form class="row g-3 mt-4">
                     <div class="col-md-7">
                        ...
                        <div class="form-icon-container">
                           <input class="form-control ps-6" id="branchName" name="branchName" type="text">
                     ...
                     <div class="col-md-5">
                        ...
                        <div class="form-icon-container">
                           <input class="form-control ps-6" id="branchCoordinates" name="branchCoordinates" type="text" placeholder="XX.XXXXXX,  - XX.XXXXXX">
                           <span class="form-icon" data-feather="map-pin" style="height: 15px; width: 15px;"></span>
                        </div>
                     </div>
                     <div class="col-md-5">
                        <label class="form-label" for="branchAddress">Calle / Avenida</label>
                        <input class="form-control" id="branchAddress" name="branchAddress" type="text">
                     </div>
                     <div class="col-6 col-md-2">
                        <label class="form-label" for="branchIntNum">Num. Interior</label>
                        <input class="form-control" id="branchIntNum" name="branchIntNum" type="text">
                     </div>
                     <div class="col-6 col-md-2">
                        <label class="form-label" for="branchExtNum">Num. Exterior</label>
                        <input class="form-control" id="branchExtNum" name="branchExtNum" type="text">
                     </div>
                     <div class="col-md-3">
                        <label class="form-label" for="branchColony">Colonia</label>
                        <input class="form-control" id="branchColony" name="branchColony" type="text">
                     </div>
                     <div class="col-6 col-md-4">
                        <label class="form-label" for="branchCity">Ciudad</label>
                        <input class="form-control" id="branchCity" name="branchCity" type="text">
                     </div>
                     <div class="col-6 col-md-3">
                        <label class="form-label" for="branchState">Estado</label>
                        <input class="form-control" id="branchState" name="branchState" type="text">
                     </div>
                     <div class="col-4 col-md-2">
                        <label class="form-label" for="branchZip">Código postal</label>
                        <input class="form-control" id="branchZip" name="branchZip" type="text">
                     </div>
                     <hr class="mt-4 mb-2">
                     <div class="col-12">
                        <h4>Horarios</h4>
                        <p class="fs-9">Selecciona los días y horarios de atención de la sucursal.</p>
                     </div>
                     <div>
                     ...
                     <div class="col-12 text-end">
                        <button class="btn btn-primary" type="submit" id="saveBranchBtn">Registrar</button>
                     </div>
                  </form>
