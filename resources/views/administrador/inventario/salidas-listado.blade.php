   ...
   <main class="main" id="top">
      ...
      <div class="content">
         ...
         <div class="d-flex justify-content-between mb-4">
            <div class="col-auto">
               <h2 class="mb-1">Salidas de marcancía</h2>
            ...
            <div class="col-xl-8">
               <div class="card card-body border-0 p-4 h-100">
                  ...
                  <div class="card bg-body d-flex align-items-center justify-content-center text-center py-8 p-15 mb-3 d-non"
                     ...
                     <div>
                        <div class="mx-auto mb-3 rounded-circle bg-kollabi-opacity d-flex align-items-center justify-content-center"
                           style="width: 90px; height: 90px;">
                           <i data-feather="package" class="text-brand" style="width: 40px; height: 40px;"></i>
                        </div>
                  ...
                  <div>
                     <div class="alert alert-subtle-secondary py-2 px-2" role="alert">
                        <span class="ms-1 me-2" data-feather="info"></span>Estos artículos va a dar de baja por <span class="fw-bold">MagentaTLX</span>. Revisa y confirma la salida física.
                     </div>
                     <!-- Table -->
