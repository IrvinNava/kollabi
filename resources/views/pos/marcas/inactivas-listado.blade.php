      ...
      <div class="content">
         ...
         <div class="mb-9">
            ...
            <div class="d-flex flex-wrap gap-2 my-3">
               <a href="{{url('app/admin/marcas')}}" class="btn btn-subtle-secondary border btn-sm">Activas (87)</a>
                        ...
                        <tbody class="list" id="marcas-table-body">
                           ...
                           <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                              <td class="marca align-middle white-space-nowrap pe-5">
                                 <a class="d-flex align-items-center text-body-emphasis" href="{{url('app/admin/marcas/marca-perfil')}}">
                              ...
                              <td class="align-middle white-space-nowrap ps-4 btn-reveal-trigger">
                                 <div class="btn-reveal-trigger position-static">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end py-2">
                                       <a class="dropdown-item" href="{{url('app/admin/marcas/marca-perfil')}}">Ver perfil</a>
