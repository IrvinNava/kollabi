                           ...
                           <div class="row gx-0 gx-sm-7">
                              ...
                              <div class="col-12 col-sm-aut">
                                 ...
                                 <div class="my-4">
                                    ...
                                    <div class="row g-2">
                                       <div class="col-10">
                                          <select class="form-select form-select-sm" id="productLocations" multiple>
                                             <option selected>Rack principal</option>
                                             <option selected>Rack superior A</option>
                                             <option selected>Estantería 1</option>
                                             <option>Estantería 2</option>
                                             <option selected>Vitrina 1</option>
                                          </select>
                                       </div>
                                       <div class="col-2">
                                          <a href="javascript:void(0);" class="btn btn-sm btn-primary px-2"><span class="fa-solid fa-check" data-fa-transform="down-3"></span></a>
                                       </div>
                                    </div>
                                 </div>
                        ...
                        <div class="row g-3 mb-3">
                           <div class="col-md-6">
                              ...
                              <div class="card card-body border-0 h-100">
                                 ...
                                 <h3 class="text-body-highlight mt-2 mb-2">$450.00</h3>
                                 <span class="text-body fw-semibold fs-9"><span class="me-2 mb-1" data-feather="calendar" style="height: 15px; width: 15px;"></span>Renueva antes del 15/mes</span>
                              </div>
                           </div>
                           <div class="col-md-6">
                           ...
                           <div class="border-top border-bottom border-translucent">
                              <div class="table-responsive">
                                 <table class="table table-sm fs-9 mb-0">
                                    <thead>
                                       <tr>
                                          <th class="align-middle text-uppercase py-2">Artículo</th>
                                          <th class="align-middle text-uppercase py-2">Monto</th>
                                          <th class="align-middle text-uppercase py-2">Fecha venta</th>
                                       </tr>
                                    </thead>
                                    <tbody>
                     ...
                     <div class="col-md-7">
                        <div class="p-3">
                           ...
                           <div class="d-flex justify-content-between mb-2">
                              ...
                              <a class="fw-bold small" href="{{url('app/admin/configuracion/planes')}}"><span class="me-1" data-feather="arrow-up-right" style="height: 12px; width: 12px;"></span>Ir a planes</a>
                           </div>
