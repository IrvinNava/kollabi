   ...
   <main class="main" id="top">
      ...
      <div class="content">
         ...
         <div class="d-flex flex-wrap gap-2 my-3">
            ...
            <a href="{{url('app/admin/inventario/paquetes')}}" class="btn btn-subtle-secondary border btn-sm">Paquetes (26)</a>
            <a href="{{url('app/admin/inventario/apartados')}}" class="btn btn-subtle-secondary border btn-sm">Apartados (18)</a>
         </div>
