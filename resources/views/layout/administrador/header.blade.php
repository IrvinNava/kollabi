<!DOCTYPE html>
<html lang="es-MX" dir="ltr" data-navigation-type="default" data-navbar-horizontal-shape="default" data-bs-theme="light">
...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('admin/img/favicon/favicon.ico') }}">
    ...
    <!-- Dropzone -->
    <link href="{{ asset('admin/vendors/dropzone/dropzone.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('admin/css/custom-styles.css') }}" type="text/css" rel="stylesheet" id="user-style-custom">
